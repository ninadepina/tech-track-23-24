<script>
    ...
    import { observe, linePathAnimation, removeIntro } from '$lib/utils/visualEl.js';
    ...
    onMount(() => {
        ...
        linePathAnimation(path, chevron);
    });
</script>
...
<div id="intro" bind:this={introContainer} class:bind={seenIntro ? 'show' : ''}>
    ...
    <section class="one">
        ...
        <span class="chevron" bind:this={chevron}></span>
    </section>
    ...
    <section class="seven">
        <button on:click={removeIntro(introContainer)}>Explore all of Schiphol’s destinations</button>
...
<style>
    ...
    .schipholHub svg path:first-of-type {
        fill: var(--color-light);
    }
    .schipholHub svg path:last-of-type {
        fill: var(--color-dark);
    }
